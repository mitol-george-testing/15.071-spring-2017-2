...
{{< youtube "j1d4_wrUEVs" "https://ocw.mit.edu/courses/sloan-school-of-management/15-071-the-analytics-edge-spring-2017/clustering/seeing-the-big-picture-segmenting-images-to-create-data-recitation/video-1-image-segmentation/video-1-image-segmentation-0/j1d4_wrUEVs.vtt" >}}

The slides from all videos in this Recitation can be downloaded here: [Segmenting Images to Create Data (PDF)]({{< baseurl >}}/resources/mit15_071s17_unit6_recitation).

*   [BackSeeing the Big Picture: Segmenting Images to Create Data (Recitation)]({{< baseurl >}}/pages/clustering/seeing-the-big-picture-segmenting-images-to-create-data-recitation)
*   [ContinueVideo 2: Clustering Pixels]({{< baseurl >}}/pages/clustering/seeing-the-big-picture-segmenting-images-to-create-data-recitation/video-2-clustering-pixels)